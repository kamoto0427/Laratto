...
@section('content')
    ...
    @csrf
        <div class="flex mt-6 mr-12">
            ...
            <div>
                <button type="submit" class="px-4 py-2 text-white text-lg transition-colors duration-200 transform bg-blue-500 rounded-md hover:bg-blue-400">下書き保存</button>
                <button type="submit" class="px-4 py-2 ml-8 text-white text-lg transition-colors duration-200 transform bg-green-500 rounded-md hover:bg-green-400">公開</button>
            </div>
        </div>
